...
- **Cursor skills** live in `.cursor/skills/`. For ticketing we use:
  ...
  - **superpowers-subagents-final-check** — after subagent code/spec reviews, reconcile feedback with the repo and create VOM tickets for remaining good recommendations; see `.cursor/skills/superpowers-subagents-final-check/SKILL.md`
